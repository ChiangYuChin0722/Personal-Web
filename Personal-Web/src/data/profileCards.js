export const profileCards = [
  {
    ...
    contentKey: {
      "zh-Hant": "我擅長把模糊目標拆成可追蹤 KPI，設計 A/B 測試，並用可視化讓團隊快速對齊。",
      en: "I break fuzzy goals into measurable KPIs, design A/B tests, and use visuals to align teams fast.",
    },
  },
  {
    id: "p2",
  ...
  },
  {
    ...
    contentKey: {
      "zh-Hant": "再酷的點子也要能跑起來。我偏好可維護、可擴展、可量化的解法。",
      en: "Even the coolest idea must run. I prefer maintainable, scalable, and measurable solutions.",
    },
  },
  {
    id: "p4",
    ...
    contentKey: {
      "zh-Hant": "我喜歡『魔法圖書館』那種氛圍：深色、金色點綴、漂浮物件、像咒語一樣的互動。",
      en: "I love a 'magical library' feel: dark tones, golden accents, floating objects, spell-like interactions.",
    },
  },
];
