...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function zo(e,t,n){let r=new Float32Array(To),i=new K(0,1,0);return new ia({name:`SphericalGaussianBlur`,defines:{n:To,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ho(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Bo(){return new ia({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ho(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vo(){return new ia({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ho(),fragmentShader:`
	...
	`}var Uo=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Fi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};zl.BlurDirectionX=new G(1,0),zl.BlurDirectionY=new G(0,1);var Bl={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Vl=class extends kl{constructor(){super(),this.isOutputPass=!0,this.uniforms=ta.clone(Bl.uniforms),this.material=new aa({name:Bl.name,uniforms:this.uniforms,vertexShader:Bl.vertexShader,fragmentShader:Bl.fragmentShader}),this._fsQuad=new Ml(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},J.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},$=n();function Hl(e){return`#`+e.toString(16).padStart(6,`0`)}var Ul={gas:14267530,ice:12574956,rocky:11563088,swirl:15128224,lava:3806732,ocean:3108789,desert:13343324,crater:10132134,neptune:2773694,toxic:11455306,forest:3111498,metallic:10134448,storm:5726590};function Wl(e,t,n){let r=e>>16&255,i=e>>8&255,a=e&255,o=t>>16&255,s=t>>8&255,c=t&255;return(r+(o-r)*n|0)<<16|(i+(s-i)*n|0)<<8|(a+(c-a)*n|0)}function Gl(e,t){let n=[0,.26,-.18,.42,-.08,.14][t%6],r=e>>16&255,i=e>>8&255,a=e&255;if(n>=0)r+=(255-r)*n,i+=(255-i)*n,a+=(255-a)*n;else{let e=1+n;r*=e,i*=e,a*=e}return(r|0)<<16|(i|0)<<8|(a|0)}var Kl=[{key:`work`,name:`作品 · Projects`,color:8086015,center:[0,2,-40],r0:6,dr:3.2,planets:[{name:`AI`,color:8086015,kind:`project`,style:`swirl`,tagline:`電腦視覺 · 深度學習 · 強化學習`,tags:[`PyTorch`,`Computer Vision`,`Deep Learning`,`RL`],projects:[{name:`UNet Pet Segmentation`,desc:`用 UNet 編碼-解碼架構做影像語意分割，調資料增強與損失函數提升 IoU。`,tech:[`Python`,`PyTorch`,`UNet`],role:`ML researcher`,impact:`掌握分割從資料、訓練到評估的完整流程。`,links:{}},{name:`DQN Reinforcement Learning`,desc:`用 Deep Q-Network 在 Gym 環境訓練 agent 自己學會決策。`,tech:[`Python`,`PyTorch`,`DQN`],role:`ML researcher`,impact:`理解探索 vs 利用、獎勵設計、收斂穩定性。`,links:{}},{name:`Fashion AI App`,desc:`結合影像理解與推薦邏輯，把「風格」變成可計算的特徵。`,tech:[`Computer Vision`,`Recommendation`],role:`Concept + prototype`,impact:`把主觀美感轉成資料問題的雛形。`,links:{}}]},{name:`Quant`,color:16765286,kind:`project`,style:`gas`,ring:!0,tagline:`量化交易 · 因子研究 · 風控`,tags:[`Quant`,`Trading`,`Finance`,`Research`],projects:[{name:`NASDAQ Quant Strategy Dashboard`,desc:`市場狀態分類 + 流派買賣規則 + 16 因子評分 + 回測（Sharpe/MDD/Kelly），純前端免後端。`,tech:[`React`,`Vite`,`lightweight-charts`,`Twelve Data`],role:`Solo — 產品 + 工程 + 量化`,impact:`從「看指標」變成完整研究流程。`,links:{demo:`/USstock`}},{name:`Supply-chain Investment Framework`,desc:`用「供應鏈卡點」視角拆解 AI / 半導體價值鏈，標出卡點、驗證證據鏈、建立研究優先序。`,tech:[`Research`,`Python`],role:`Researcher / Analyst`,impact:`把「我覺得會漲」變成有證據、可排序的流程。`,links:{}}]},{name:`Web`,color:54527,kind:`project`,style:`ocean`,tagline:`前端工程 · 儀表板 · UI/UX`,tags:[`React`,`Vite`,`Vue`,`UI/UX`],projects:[{name:`The Chiangverse / Portfolio`,desc:`chianghebe.com — React + Vite 單頁應用 + 路徑路由，部署到 GitHub Pages + 自訂網域。`,tech:[`React 19`,`Vite`,`three.js`],role:`Solo — 設計 + 工程`,impact:`新作品加一條路由就上線。`,links:{demo:`/cv`}},{name:`Quant Dashboard Frontend`,desc:`瀏覽器端的因子評分量化系統（迷你 TradingView）。`,tech:[`React`,`lightweight-charts`,`Firebase`],role:`Frontend`,impact:`純前端、可雲端儲存策略。`,links:{demo:`/USstock`}}]},{name:`Mobile`,color:4647072,kind:`project`,style:`crater`,tagline:`跨平台 App · 推播 · 雲端`,tags:[`React Native`,`Expo`,`Firebase`],projects:[{name:`KidsDay React Native Migration`,desc:`把兒童活動 App 以 Expo 重建，整合 Google / Apple 登入、雲端資料與推播。`,tech:[`React Native`,`Expo`,`Firebase`],role:`Mobile developer`,impact:`更好維護的單一程式碼庫。`,links:{}},{name:`Notification & Album Upload`,desc:`推播通知系統與相簿上傳流程，串接雲端儲存與即時同步。`,tech:[`React Native`,`Firebase`],role:`Mobile developer`,impact:`把零散功能整合成順暢流程。`,links:{}}]},{name:`Media`,color:16740039,kind:`project`,style:`lava`,tagline:`敘事 · 影音製作 · 新聞`,tags:[`Storytelling`,`Video`,`Research`],projects:[{name:`AI Fashion Education Video`,desc:`把 AI 與時尚教育結合，用影音把複雜概念講清楚。`,tech:[`Video`,`Storytelling`],role:`Producer / Creator`,impact:`把「複雜變清楚」的內容力。`,links:{}},{name:`K-pop Sustainability · Journalism`,desc:`新聞 / 影音專題：從企劃、拍攝到剪輯，把資料與故事結合成有節奏的敘事。`,tech:[`Video`,`Editing`],role:`Producer / Creator`,impact:`培養內容敘事力。`,links:{}}]}]},{key:`edu`,name:`學歷 · Education`,color:6015231,center:[-46,16,16],r0:5,dr:3,planets:[{name:`University of Warwick`,kind:`edu`,sub:`MSc Data Analytics · 英國`,period:`2025 – 2027`,extra:`預期優等 Distinction`,bullets:[`機器學習演算法與實務、資料分析基礎`,`自然語言處理、高效能運算、進階電腦安全`,`演算法賽局理論、研究方法`]},{name:`Chang Gung University`,kind:`edu`,sub:`資訊管理（雙主修：資訊工程）· 台灣`,period:`2021 – 2025`,extra:`GPA 3.8 / 4.0`,bullets:[]}]},{key:`exp`,name:`經歷 · Experience`,color:16760909,center:[48,-14,18],r0:5,dr:2.4,planets:[{name:`網銀國際 Wanin`,kind:`exp`,sub:`遊戲數據分析師 & 網頁開發 · 台灣`,period:`2024 – 2025`,bullets:[`分析 50,000+ 事件以驗證 RNG 公平性並偵測異常`,`改善獎勵演算法，公平性感知提升 15%`,`以 Python 和 Excel 提供平衡建議`]},{name:`Kidsday Xgree`,kind:`exp`,sub:`數據分析師（軟體部門）· 台灣`,period:`2023 – 2025`,bullets:[`以 Python 建立分析工具追蹤留存、健康指標與產品表現`,`建立儀表板與自動化報表供利害關係人使用`,`跨部門協作推動數據導向的產品決策`]},{name:`長庚大學 · 學生滿意度研究`,kind:`exp`,sub:`數據分析師 · 台灣`,period:`2023 – 2024`,bullets:[`分析大規模學生問卷，找出滿意度與留存驅動因素`,`建立儀表板與統計摘要支持機構決策`,`向學術與行政團隊提供數據支持的建議`]},{name:`長庚大學 · 量化交易`,kind:`exp`,sub:`量化交易研究助理 · 台灣`,period:`2022 – 2023`,bullets:[`以 Python 分析資產報酬與策略行為`,`建立回測流程並評估模擬投組的風險回報`,`向學術督導呈現研究結果輔助模型開發`]},{name:`KBI Food Machinery`,kind:`exp`,sub:`軟體工程師 · 台中，台灣`,period:`2021 – 2023`,bullets:[`導入大數據處理技術，優化網站效能、安全性與即時分析`]}]},{key:`cert`,name:`證照 · Certificates`,color:9102940,center:[6,24,46],r0:5,dr:2.1,planets:[{name:`IBM Data Science`,kind:`cert`,sub:`資料分析 & 機器學習基礎`},{name:`DeepLearning.AI ML`,kind:`cert`,sub:`監督式學習、決策樹、神經網路`},{name:`IELTS Academic`,kind:`cert`,sub:`總分 7.5`},{name:`Google Data Analytics`,kind:`cert`,sub:`資料清理、視覺化、SQL、Tableau`},{name:`Duolingo English Test`,kind:`cert`,sub:`英語語言能力認證`},{name:`AWS Cloud Practitioner`,kind:`cert`,sub:`進行中 · 預計 2026 / 04`},{name:`CFA Level I Candidate`,kind:`cert`,sub:`進行中 · 預計 2026 / 08`}]},{key:`contact`,name:`聯絡 · Contact`,color:16741301,center:[-28,-20,42],r0:5,dr:2.4,planets:[{name:`Email`,kind:`contact`,sub:`hebe4090409@gmail.com`,link:`mailto:hebe4090409@gmail.com`},{name:`LinkedIn`,kind:`contact`,sub:`江昱瑾`,link:`https://www.linkedin.com/in/%E6%98%B1%E7%91%BE-%E6%B1%9F-3a5720222/`},{name:`GitHub`,kind:`contact`,sub:`ChiangYuChin0722`,link:`https://github.com/ChiangYuChin0722`},{name:`LeetCode`,kind:`contact`,sub:`ChiangYuChin`,link:`https://leetcode.com/u/ChiangYuChin/`},{name:`Instagram`,kind:`contact`,sub:`@chiang_hebe`,link:`https://www.instagram.com/chiang_hebe/`}]}],ql=[`rocky`,`gas`,`ice`,`swirl`,`desert`,`crater`,`ocean`,`lava`,`neptune`,`toxic`,`forest`,`metallic`,`storm`],Jl=[],Yl=0;Kl.forEach(e=>{e.planets.forEach((t,n)=>{let r=t.style||ql[Yl++%ql.length];Jl.push({...t,color:Gl(e.color,n),systemKey:e.key,systemName:e.name,systemColor:e.color,style:r,ring:t.ring||r===`gas`,size:t.kind===`project`?1.9:1.4,center:e.center,localRadius:e.r0+n*e.dr,baseAngle:n*2.39996,localY:(n%2?1:-1)*1.1,orbitSpeed:(e.key===`work`?.06:.12)*(1-n*.04)})})});function Xl(){let e=(0,r.useRef)(null),t=(0,r.useRef)(-1),[n,i]=(0,r.useState)(-1),[a,o]=(0,r.useState)(-1),[s,c]=(0,r.useState)(()=>new Set),[l,u]=(0,r.useState)(!1),d=(0,r.useRef)(!1),[f,p]=(0,r.useState)(!1),[m,h]=(0,r.useState)(!1),[g,_]=(0,r.useState)(!1),[v,y]=(0,r.useState)(null),b=(0,r.useCallback)(()=>{let n=t.current;n<0||(o(n),c(e=>new Set(e).add(n)),e.current?._audio?.blip())},[]),x=(0,r.useRef)(b);(0,r.useEffect)(()=>{x.current=b},[b]);let S=(0,r.useCallback)(()=>{u(!0),d.current=!0,e.current?._audio?.init()},[]);(0,r.useEffect)(()=>{let n=e.current;if(!n)return;let r=n.clientWidth,a=n.clientHeight,o=new URLSearchParams(window.location.search).has(`nobloom`),s=new Dl({antialias:!0,powerPreference:`high-performance`});s.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),s.setSize(r,a),s.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault()}),s.toneMapping=4,s.toneMappingExposure=1,n.appendChild(s.domElement);let c=new Fn;c.background=(()=>{let e=document.createElement(`canvas`);e.width=4,e.height=256;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,0,256);n.addColorStop(0,`#0a0f24`),n.addColorStop(.5,`#0d1230`),n.addColorStop(1,`#171540`),t.fillStyle=n,t.fillRect(0,0,4,256);let r=new Ii(e);return r.colorSpace=ze,r})(),c.fog=new Pn(790576,.0026);let l=new Ra(60,r/a,.1,1e3);c.add(new Wa(7043750,.5)),c.add(new Ea(9149391,1446440,.4));let f=new Ua(16774374,1.5);f.position.set(40,48,22),c.add(f);let p=new Il(s);p.addPass(new Ll(c,l)),p.addPass(new zl(new G(r,a),.5,.5,.92)),p.addPass(new Vl);let m=(()=>{let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(64,64,0,64,64,64);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.25,`rgba(255,255,255,0.5)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,128,128),new Ii(e)})(),h=(e,t)=>{let n=new Yr(new Fr({map:m,color:e,transparent:!0,blending:2,depthWrite:!1}));return n.scale.set(t,t,1),n},g=(e,t,n)=>{let r=document.createElement(`canvas`).getContext(`2d`);r.font=`600 64px sans-serif`;let i=Math.ceil(r.measureText(e).width)+60,a=document.createElement(`canvas`);a.width=i,a.height=140;let o=a.getContext(`2d`);o.font=`600 64px sans-serif`,o.textAlign=`center`,o.textBaseline=`middle`,o.shadowColor=`rgba(0,0,0,0.85)`,o.shadowBlur=10,o.fillStyle=`#ffffff`,o.fillText(e,i/2,140/2),o.shadowBlur=0,o.fillStyle=Hl(t),o.globalAlpha=.9,o.fillText(e,i/2,140/2),o.globalAlpha=1;let s=new Ii(a);s.anisotropy=4;let c=new Yr(new Fr({map:s,transparent:!0,depthWrite:!1})),l=2.1*n;return c.scale.set(l*(i/140),l,1),c},_=(e,t)=>`rgb(${Math.min(255,(e>>16&255)*t)|0},${Math.min(255,(e>>8&255)*t)|0},${Math.min(255,(e&255)*t)|0})`,v=(e,t)=>{let n=document.createElement(`canvas`);n.width=512,n.height=256;let r=n.getContext(`2d`);if(r.fillStyle=_(e,.5),r.fillRect(0,0,512,256),t===`gas`){for(let t=0;t<256;t+=2)r.fillStyle=_(e,.3+(.42+.58*Math.abs(Math.sin(t*.05+Math.sin(t*.014)*2.6)))*.95),r.fillRect(0,t,512,2);for(let t=0;t<26;t++)r.globalAlpha=.16,r.fillStyle=_(e,.5+Math.random()*.9),r.beginPath(),r.ellipse(Math.random()*512,Math.random()*256,30+Math.random()*70,4+Math.random()*7,0,0,7),r.fill();for(let e=0;e<5;e++)r.globalAlpha=.3,r.fillStyle=`rgba(245,238,222,0.9)`,r.fillRect(0,Math.random()*256,512,3+Math.random()*5);r.globalAlpha=.6,r.fillStyle=`rgba(190,95,60,0.85)`,r.beginPath(),r.ellipse(512*.66,256*.6,46,24,0,0,7),r.fill(),r.globalAlpha=.4,r.fillStyle=`rgba(150,70,45,0.8)`,r.beginPath(),r.ellipse(512*.66,256*.6,30,15,0,0,7),r.fill(),r.globalAlpha=1}else if(t===`swirl`){for(let t=0;t<70;t++)r.globalAlpha=.12,r.fillStyle=_(e,.4+Math.random()*.95),r.beginPath(),r.ellipse(Math.random()*512,Math.random()*256,22+Math.random()*65,8+Math.random()*30,Math.random()*Math.PI,0,7),r.fill();r.globalAlpha=1}else if(t===`lava`){r.fillStyle=_(e,.45),r.fillRect(0,0,512,256);for(let e=0;e<70;e++){r.strokeStyle=`rgba(255,${110+Math.random()*110|0},${20+Math.random()*40|0},${.65+Math.random()*.35})`,r.globalAlpha=1,r.lineWidth=1+Math.random()*2.5,r.beginPath();let e=Math.random()*512,t=Math.random()*256;r.moveTo(e,t);for(let n=0;n<5;n++)e+=Math.random()*44-22,t+=Math.random()*30-15,r.lineTo(e,t);r.stroke()}for(let e=0;e<60;e++)r.fillStyle=`rgba(255,${180+Math.random()*60|0},${60+Math.random()*60|0},0.9)`,r.beginPath(),r.arc(Math.random()*512,Math.random()*256,1+Math.random()*3,0,7),r.fill()}else if(t===`ocean`){r.fillStyle=_(e,.85),r.fillRect(0,0,512,256);let t=[`#3f7a3f`,`#4f7a36`,`#6e5a38`,`#8a7048`];for(let e=0;e<16;e++)r.globalAlpha=.85,r.fillStyle=t[e%t.length],r.beginPath(),r.ellipse(Math.random()*512,36+Math.random()*184,22+Math.random()*50,16+Math.random()*28,Math.random(),0,7),r.fill();for(let e=0;e<24;e++)r.globalAlpha=.2,r.fillStyle=`rgba(255,255,255,0.95)`,r.beginPath(),r.ellipse(Math.random()*512,Math.random()*256,22+Math.random()*42,6+Math.random()*11,Math.random(),0,7),r.fill();r.globalAlpha=.9,r.fillStyle=`rgba(244,249,255,0.95)`,r.beginPath(),r.ellipse(512/2,6,512*.5,20,0,0,7),r.fill(),r.beginPath(),r.ellipse(512/2,250,512*.5,20,0,0,7),r.fill(),r.globalAlpha=1}else if(t===`desert`){for(let t=0;t<256;t+=2)r.fillStyle=_(e,.55+(.55+.45*Math.sin(t*.04+Math.sin(t*.1)))*.55),r.fillRect(0,t,512,2);for(let t=0;t<30;t++){r.globalAlpha=.18,r.strokeStyle=_(e,.4),r.lineWidth=1+Math.random()*2;let t=Math.random()*256;r.beginPath(),r.moveTo(0,t),r.bezierCurveTo(512*.3,t+22,512*.6,t-22,512,t+Math.random()*20-10),r.stroke()}r.globalAlpha=1}else if(t===`crater`){for(let t=0;t<2400;t++)r.fillStyle=_(e,.4+Math.random()*.7),r.fillRect(Math.random()*512,Math.random()*256,2,2);for(let t=0;t<64;t++){let t=Math.random()*512,n=Math.random()*256,i=4+Math.random()*16;r.globalAlpha=.4,r.fillStyle=_(e,.35),r.beginPath(),r.arc(t,n,i,0,7),r.fill(),r.globalAlpha=.5,r.strokeStyle=_(e,1.15),r.lineWidth=1.5,r.beginPath(),r.arc(t,n,i,0,7),r.stroke()}r.globalAlpha=1}else if(t===`neptune`){for(let t=0;t<256;t+=2)r.fillStyle=_(e,.6+(.6+.4*Math.sin(t*.04))*.6),r.fillRect(0,t,512,2);r.globalAlpha=.4,r.fillStyle=_(e,.4),r.beginPath(),r.ellipse(512*.4,256*.42,40,22,0,0,7),r.fill();for(let e=0;e<8;e++)r.globalAlpha=.2,r.fillStyle=`rgba(255,255,255,0.7)`,r.beginPath(),r.ellipse(Math.random()*512,Math.random()*256,18+Math.random()*30,3+Math.random()*4,0,0,7),r.fill();r.globalAlpha=1}else if(t===`toxic`){for(let t=0;t<80;t++)r.globalAlpha=.12,r.fillStyle=_(e,.5+Math.random()*.9),r.beginPath(),r.ellipse(Math.random()*512,Math.random()*256,24+Math.random()*60,8+Math.random()*24,Math.random()*Math.PI,0,7),r.fill();for(let e=0;e<12;e++)r.globalAlpha=.18,r.fillStyle=`rgba(90,120,30,0.8)`,r.beginPath(),r.ellipse(Math.random()*512,Math.random()*256,16+Math.random()*30,12+Math.random()*20,0,0,7),r.fill();r.globalAlpha=1}else if(t===`forest`){r.fillStyle=`#27568a`,r.fillRect(0,0,512,256);let e=[`#2f7a44`,`#3c8a3a`,`#4f7a36`,`#256b3a`];for(let t=0;t<22;t++)r.globalAlpha=.9,r.fillStyle=e[t%e.length],r.beginPath(),r.ellipse(Math.random()*512,Math.random()*256,26+Math.random()*56,18+Math.random()*34,Math.random(),0,7),r.fill();for(let e=0;e<16;e++)r.globalAlpha=.18,r.fillStyle=`rgba(255,255,255,0.9)`,r.beginPath(),r.ellipse(Math.random()*512,Math.random()*256,20+Math.random()*38,6+Math.random()*10,Math.random(),0,7),r.fill();r.globalAlpha=1}else if(t===`metallic`){r.fillStyle=_(e,.7),r.fillRect(0,0,512,256);for(let t=0;t<40;t++)r.globalAlpha=.3,r.fillStyle=_(e,.6+Math.random()*.8),r.fillRect(Math.random()*512,Math.random()*256,6+Math.random()*60,2+Math.random()*5);for(let t=0;t<30;t++)r.globalAlpha=.35,r.strokeStyle=_(e,1.2),r.lineWidth=1,r.strokeRect(Math.random()*512,Math.random()*256,10+Math.random()*40,8+Math.random()*30);r.globalAlpha=1}else if(t===`storm`){for(let t=0;t<256;t+=2)r.fillStyle=_(e,.25+(.4+.6*Math.abs(Math.sin(t*.06+Math.sin(t*.02)*3)))*.8),r.fillRect(0,t,512,2);for(let e=0;e<30;e++){r.globalAlpha=.7,r.strokeStyle=`rgba(220,235,255,0.9)`,r.lineWidth=1,r.beginPath();let e=Math.random()*512,t=Math.random()*256;r.moveTo(e,t);for(let n=0;n<3;n++)e+=Math.random()*26-13,t+=Math.random()*20-6,r.lineTo(e,t);r.stroke()}r.globalAlpha=1}else if(t===`ice`){r.fillStyle=_(e,.85),r.fillRect(0,0,512,256);for(let t=0;t<120;t++){r.strokeStyle=_(e,.4),r.globalAlpha=.3,r.lineWidth=1+Math.random();let t=Math.random()*512,n=Math.random()*256;r.beginPath(),r.moveTo(t,n),r.lineTo(t+Math.random()*80-40,n+Math.random()*50-25),r.stroke()}for(let t=0;t<30;t++)r.globalAlpha=.25,r.fillStyle=_(e,1.2),r.beginPath(),r.ellipse(Math.random()*512,Math.random()*256,18+Math.random()*30,14+Math.random()*20,0,0,7),r.fill();r.globalAlpha=1}else{for(let t=0;t<5200;t++)r.fillStyle=_(e,.3+Math.random()*.9),r.fillRect(Math.random()*512,Math.random()*256,2,2);for(let t=0;t<14;t++)r.globalAlpha=.3,r.fillStyle=_(e,.55+Math.random()*.6),r.beginPath(),r.ellipse(Math.random()*512,Math.random()*256,22+Math.random()*46,16+Math.random()*30,Math.random(),0,7),r.fill();r.globalAlpha=.85,r.fillStyle=`rgba(235,242,255,0.9)`,r.beginPath(),r.ellipse(512/2,6,512*.5,22,0,0,7),r.fill(),r.beginPath(),r.ellipse(512/2,250,512*.5,22,0,0,7),r.fill(),r.globalAlpha=1}let i=new Ii(n);return i.colorSpace=ze,i.anisotropy=4,i},b=new kr,S=2400,C=new Float32Array(S*3);for(let e=0;e<S;e++){let t=150+Math.random()*340,n=Math.random()*Math.PI*2,r=Math.acos(2*Math.random()-1);C[e*3]=t*Math.sin(r)*Math.cos(n),C[e*3+1]=t*Math.cos(r)*.7,C[e*3+2]=t*Math.sin(r)*Math.sin(n)}b.setAttribute(`position`,new mr(C,3));let w=new Ni(b,new Oi({color:13489919,size:.85,sizeAttenuation:!0,transparent:!0,opacity:.9}));c.add(w),[[3811962,90,-60,14,-60],[1065067,110,70,-10,-70],[5909099,80,-50,-24,60]].forEach(([e,t,n,r,i])=>{let a=h(e,t);a.position.set(n,r,i),a.material.opacity=.4,c.add(a)});let T=new X(new Gi(3.2,3),new oa({color:15397631,emissive:12374783,emissiveIntensity:1.1,roughness:.3}));c.add(T);let E=h(12374783,9);E.material.opacity=.7,c.add(E),c.add(new Ba(13623551,1.8,240,1.3));let D=[],O=[];Kl.forEach(e=>{let[t,n,r]=e.center,i=new X(new Ji(2.2,32,32),new oa({color:16777215,emissive:e.color,emissiveIntensity:.85,roughness:.4}));i.position.set(t,n,r),c.add(i);let a=h(e.color,8);a.material.opacity=.7,a.position.set(t,n,r),c.add(a);let o=new Ba(e.color,2.8,170,1.4);o.position.set(t,n,r),c.add(o);let s=g(e.name,e.color,1.5);s.position.set(t,n+e.r0+e.dr*(e.planets.length-1)+6,r),c.add(s),O.push({sun:i,halo:a})}),Jl.forEach(e=>{let t=new En,n=Wl(Ul[e.style]||e.color,e.color,.06),r=v(n,e.style),i={crater:.6,rocky:.55,lava:.5,desert:.35,gas:.3,swirl:.28,storm:.3,toxic:.28,forest:.3,neptune:.2,ice:.2,ocean:.16,metallic:.14}[e.style]??.3,a=e.style===`metallic`,o=e.style===`ocean`||e.style===`forest`,s=new X(new Ji(e.size,64,48),new oa({map:r,bumpMap:r,bumpScale:i,roughness:a?.28:o?.55:.82,metalness:a?.85:o?.2:.08,emissive:n,emissiveIntensity:.04}));s.rotation.z=(Math.random()-.5)*.5,s.rotation.x=.3,t.add(s);let l=new X(new Ji(e.size*1.14,32,32),new ai({color:e.color,transparent:!0,opacity:.09,side:1,blending:2,depthWrite:!1}));if(t.add(l),e.ring){let n=new X(new qi(e.size*1.5,e.size*2.5,56),new ai({color:k(e.color,1.2),transparent:!0,opacity:.55,side:2,depthWrite:!1}));n.rotation.x=-Math.PI/2.3,n.rotation.y=.2,t.add(n)}let u=h(e.color,e.size*2.1);u.material.opacity=.16,t.add(u);let d=[],f=e.kind===`project`?e.ring?1:2:0;for(let n=0;n<f;n++){let i=new X(new Ji(e.size*(.16+n*.04),16,14),new oa({color:13620708,roughness:.95,bumpMap:r,bumpScale:.06}));t.add(i),d.push({mesh:i,r:e.size*(2.4+n*.9),a:n*2.1,tilt:.3+n*.4,speed:.7-n*.2})}let p=g(e.name,e.color,e.kind===`project`?.95:.7);p.position.y=e.size+1.6,t.add(p);let m=e.center;t.position.set(m[0]+Math.cos(e.baseAngle)*e.localRadius,m[1]+e.localY,m[2]+Math.sin(e.baseAngle)*e.localRadius),c.add(t);let _=new X(new qi(e.localRadius-.05,e.localRadius+.05,80),new ai({color:e.systemColor,transparent:!0,opacity:.08,side:2,depthWrite:!1}));_.rotation.x=-Math.PI/2,_.position.set(m[0],m[1]+e.localY,m[2]),c.add(_),D.push({grp:t,mesh:s,atmo:l,halo:u,label:p,moons:d,data:e,ang:e.baseAngle})});function k(e,t){let n=Math.min(255,(e>>16&255)*t)|0,r=Math.min(255,(e>>8&255)*t)|0,i=Math.min(255,(e&255)*t)|0;return n<<16|r<<8|i}let A=new En,j=new En;A.add(j);let ee=new En;j.add(ee);let M=new oa({color:13422808,roughness:.5,metalness:.55}),te=new oa({color:3554116,roughness:.6,metalness:.4}),ne=new oa({color:14173499,roughness:.5,metalness:.3,emissive:3804426,emissiveIntensity:.3}),N=new oa({color:1254447,roughness:.1,metalness:.6,emissive:797756,emissiveIntensity:.5}),re=new X(new Bi(.5,.42,2.6),M);ee.add(re);let ie=new X(new Ui(.34,1.5,4),M);ie.rotation.x=Math.PI/2,ie.rotation.z=Math.PI/4,ie.position.z=2,ee.add(ie);let ae=new X(new Bi(.46,.4,.16),ne);ae.position.z=1.2,ee.add(ae);let oe=new X(new Ji(.3,18,12,0,Math.PI*2,0,Math.PI/2),N);oe.scale.set(1,.85,1.5),oe.position.set(0,.24,.25),ee.add(oe);let P=new X(new Ji(.15,14,10,0,Math.PI*2,0,Math.PI/2),new oa({color:14870253,roughness:.5}));P.position.set(0,.26,-.55),ee.add(P);let se=new X(new Bi(.12,.05,.02),new oa({color:3899346,emissive:3899346,emissiveIntensity:.6}));se.position.set(0,.32,-.41),ee.add(se);let ce=new X(new Bi(.62,.5,.7),te);ce.position.z=-1.25,ee.add(ce);let F=[];[[1,1],[-1,1],[1,-1],[-1,-1]].forEach(([e,t])=>{let n=new En,r=new X(new Bi(1.9,.06,.82),M);r.position.set(e*1.05,0,-.6),n.add(r);let i=new X(new Bi(.46,.075,.82),ne);i.position.set(e*1.68,0,-.6),n.add(i);let a=new X(new Hi(.05,.05,2.5,8),te);a.rotation.x=Math.PI/2,a.position.set(e*1.95,0,.35),n.add(a);let o=new X(new Hi(.07,.04,.34,8),new oa({color:16734780,emissive:16726554,emissiveIntensity:.7}));o.rotation.x=Math.PI/2,o.position.set(e*1.95,0,1.6),n.add(o);let s=new X(new Hi(.17,.19,.78,16),te);s.rotation.x=Math.PI/2,s.position.set(e*.58,0,-1.02),n.add(s);let c=new X(new Hi(.2,.13,.18,16),new oa({color:1316895,metalness:.6,roughness:.4}));c.rotation.x=Math.PI/2,c.position.set(e*.58,0,-1.42),n.add(c);let l=new X(new Yi(.16,.03,8,18),new oa({color:2106927}));l.position.set(e*.58,0,-.62),n.add(l);let u=new X(new Ui(.16,1.1,14,1,!0),new ai({color:10154239,transparent:!0,opacity:.6,blending:2,depthWrite:!1,side:2}));u.rotation.x=-Math.PI/2,u.position.set(e*.58,0,-2.05),n.add(u);let d=h(7267327,1.2);d.position.set(e*.58,0,-1.5),n.add(d),F.push(d),n.rotation.z=e*t*.32,ee.add(n)}),A.scale.setScalar(.82),A.position.set(0,4,-18),c.add(A);let le=new En,ue=new X(new Hi(1.5,1.5,.3,24),new oa({color:10134456,metalness:.75,roughness:.3}));ue.scale.set(1,1,1.2),le.add(ue);let de=new X(new Yi(1.5,.13,10,28),new oa({color:4805742,metalness:.6}));de.rotation.x=Math.PI/2,le.add(de);let fe=new X(new Ji(.62,18,12,0,Math.PI*2,0,Math.PI/2),new oa({color:9430783,emissive:2779786,emissiveIntensity:.7,transparent:!0,opacity:.85}));fe.position.y=.16,le.add(fe);let pe=[];for(let e=0;e<6;e++){let t=e/6*Math.PI*2,n=h(7274400,.7);n.position.set(Math.cos(t)*1.2,-.18,Math.sin(t)*1.2),le.add(n),pe.push(n)}le.position.set(-64,34,-22),c.add(le);let me=new En,he=new oa({color:15790838,roughness:.65});me.add(new X(new Vi(.42,.5,6,12),he));let ge=new X(new Ji(.36,18,16),new oa({color:15133940,roughness:.3,metalness:.4}));ge.position.y=.62,me.add(ge);let _e=new X(new Ji(.3,16,12,0,Math.PI*2,Math.PI*.16,Math.PI*.5),new oa({color:1187886,metalness:.7,roughness:.1,emissive:663600,emissiveIntensity:.4}));_e.position.set(0,.64,.18),_e.rotation.x=.3,me.add(_e),[.55,-.55].forEach(e=>{let t=new X(new Vi(.14,.42,4,8),he);t.position.set(e,.08,0),t.rotation.z=e>0?.6:-.6,me.add(t)});let ve=new X(new Bi(.5,.5,.26),new oa({color:12106948}));ve.position.set(0,.06,-.36),me.add(ve),me.position.set(58,-8,58),me.scale.setScalar(1.4),c.add(me);let ye=new En;ye.add(new X(new Ji(.7,16,16),new oa({color:15135743,emissive:10475775,emissiveIntensity:1.4,roughness:.4})));let be=h(11066879,9);be.position.set(0,0,3.6),be.scale.set(3,9,1),ye.add(be),c.add(ye);let xe=g(`MAY THE DATA BE WITH YOU`,16765286,1.5);xe.position.set(0,40,4),c.add(xe);let Se=new En,Ce=new oa({color:5659758,roughness:1,flatShading:!0});for(let e=0;e<70;e++){let e=new X(new Gi(.3+Math.random()*.7,0),Ce),t=Math.random()*Math.PI*2,n=66+Math.random()*16;e.position.set(Math.cos(t)*n,(Math.random()-.5)*7,Math.sin(t)*n),e.rotation.set(Math.random()*3,Math.random()*3,Math.random()*3),Se.add(e)}c.add(Se),[[10124287,-190,46,-210,64],[6211839,210,-40,-190,54],[16747216,-60,-70,220,48]].forEach(([e,t,n,r,i])=>{let a=h(e,i);a.position.set(t,n,r),a.material.opacity=.45,c.add(a)});let we=new En;we.add(new X(new Ji(1.7,24,24),new ai({color:0})));let Te=new X(new qi(2,4.6,56),new ai({color:16757866,transparent:!0,opacity:.85,side:2,blending:2,depthWrite:!1}));Te.rotation.x=-Math.PI/2.3,we.add(Te);let Ee=h(16766624,7);we.add(Ee),we.position.set(74,40,-54),c.add(we);let De=new En;De.add(new X(new Bi(.6,.6,.95),new oa({color:13159636,metalness:.6,roughness:.4}))),[-1,1].forEach(e=>{let t=new X(new Bi(1.7,.05,.7),new oa({color:2179194,emissive:661552,emissiveIntensity:.5,metalness:.3,roughness:.5}));t.position.set(e*1.35,0,0),De.add(t)});let Oe=new X(new Ji(.32,14,8,0,Math.PI*2,0,Math.PI/2),new oa({color:15133940,roughness:.5}));Oe.rotation.x=Math.PI/2,Oe.position.z=.62,De.add(Oe),De.position.set(-52,-30,-8),c.add(De);let ke=new En;ke.add(new X(new Hi(.4,.4,1.6,16),new oa({color:15790838,roughness:.5})));let I=new X(new Ui(.4,.7,16),new oa({color:14173499}));I.position.y=1.15,ke.add(I);let Ae=new X(new Ji(.16,12,10),new oa({color:9429247,emissive:2779786,emissiveIntensity:.5}));Ae.position.set(0,.3,.38),ke.add(Ae),[0,1,2].forEach(e=>{let t=e/3*Math.PI*2,n=new X(new Bi(.1,.5,.5),new oa({color:14173499}));n.position.set(Math.cos(t)*.42,-.7,Math.sin(t)*.42),n.rotation.y=-t,ke.add(n)});let L=h(16760928,1.3);L.position.y=-1.15,ke.add(L),ke.position.set(44,50,34),ke.rotation.z=.5,c.add(ke);let je=[],R=[];for(let e=0;e<22;e++){let e=h(54527,1.4);e.material.opacity=0,c.add(e),je.push(e)}let Me=(()=>{let e,t,n,r=!1;return{init(){if(r)return;let i=window.AudioContext||window.webkitAudioContext;if(i)try{e=new i,r=!0,t=e.createGain(),t.gain.value=.5,t.connect(e.destination);let a=e.createGain();a.gain.value=.05,a.connect(t);let o=e.createBiquadFilter();o.type=`lowpass`,o.frequency.value=380,o.connect(a),[55,55.4,82.5].forEach(t=>{let n=e.createOscillator();n.type=`sine`,n.frequency.value=t,n.connect(o),n.start()}),n=e.createGain(),n.gain.value=0,n.connect(t);let s=e.createBiquadFilter();s.type=`lowpass`,s.frequency.value=620,s.connect(n);let c=e.createOscillator();c.type=`sawtooth`,c.frequency.value=68,c.connect(s),c.start()}catch{r=!1}},thrust(t){r&&n.gain.setTargetAtTime(t*.11,e.currentTime,.12)},blip(){if(!r)return;let n=e.createOscillator(),i=e.createGain();n.type=`triangle`,n.frequency.setValueAtTime(680,e.currentTime),n.frequency.exponentialRampToValueAtTime(1360,e.currentTime+.12),i.gain.setValueAtTime(1e-4,e.currentTime),i.gain.exponentialRampToValueAtTime(.14,e.currentTime+.02),i.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+.25),n.connect(i),i.connect(t),n.start(),n.stop(e.currentTime+.3)},setMuted(n){r&&t.gain.setTargetAtTime(n?0:.5,e.currentTime,.05)},close(){if(r)try{e.close()}catch{}}}})();n._audio=Me;let z={f:!1,b:!1,l:!1,r:!1,space:!1,av:!1,ad:!1,boost:!1},B=(e,t)=>{e in z&&(z[e]=t)},Ne={ArrowUp:`f`,KeyW:`f`,ArrowDown:`b`,KeyS:`b`,ArrowLeft:`l`,KeyA:`l`,ArrowRight:`r`,KeyD:`r`,Space:`space`,ShiftLeft:`boost`,ShiftRight:`boost`},Pe=e=>{if(e.code===`Enter`){x.current();return}Ne[e.code]&&(B(Ne[e.code],!0),e.preventDefault(),d.current||(d.current=!0,u(!0),Me.init()))},Fe=e=>{Ne[e.code]&&(B(Ne[e.code],!1),e.preventDefault())};window.addEventListener(`keydown`,Pe),window.addEventListener(`keyup`,Fe),n._setKey=B,n._begin=()=>{d.current=!0,u(!0),Me.init()};let Ie=0,Le=0,Re=new K,Be=0,Ve=0,He=-1,Ue=0,We=performance.now(),Ge=0,Ke=new K(0,20,-56),qe=new K,Je=new K,Ye=new K,Xe=new kt,Ze=new K,Qe=!1;function $e(e){Ue=requestAnimationFrame($e);try{let n=(e-We)/1e3;We=e;let r=Math.min(n,.05);Ge+=r,T.rotation.y+=r*.2,T.rotation.x+=r*.08;let a=1+Math.sin(Ge*1.5)*.06;E.scale.set(9*a,9*a,1),w.rotation.y+=r*.004;for(let e of O)e.sun.rotation.y+=r*.15;le.rotation.y+=r*.6,le.position.y=34+Math.sin(Ge*.6)*2;for(let e=0;e<pe.length;e++)pe[e].material.opacity=.35+.5*(.5+.5*Math.sin(Ge*4+e));me.rotation.x+=r*.25,me.rotation.y+=r*.18,me.rotation.z+=r*.12,me.position.y=-8+Math.sin(Ge*.4)*3;let u=Ge*.05%1;ye.position.set(-95+u*190,54-u*26,-42+Math.sin(u*Math.PI)*22),ye.rotation.set(0,-Math.PI/2,.32),Se.rotation.y+=r*.02,Te.rotation.z+=r*.5,De.rotation.y+=r*.3,De.position.y=-30+Math.sin(Ge*.5)*2,ke.position.y=50+Math.sin(Ge*.3)*4,ke.rotation.y+=r*.4,L.scale.setScalar(1+Math.sin(Ge*25)*.2);for(let e of D){e.ang+=e.data.orbitSpeed*r;let t=e.data.center;if(e.grp.position.set(t[0]+Math.cos(e.ang)*e.data.localRadius,t[1]+e.data.localY,t[2]+Math.sin(e.ang)*e.data.localRadius),e.mesh.rotation.y+=r*.25,e.moons)for(let t of e.moons)t.a+=t.speed*r,t.mesh.position.set(Math.cos(t.a)*t.r,Math.sin(t.a)*t.r*t.tilt,Math.sin(t.a)*t.r)}let f=z.boost,m=f?100:54,h=f?115:72,g=z.av||z.space&&z.f,_=z.ad||z.space&&z.b,v=z.f&&!z.space||g||_,y=z.b&&!z.space,b=(z.l?1:0)-(z.r?1:0);Le+=(b-Le)*Math.min(1,r*5),Ie+=Le*1.9*r,Be+=(-Le*.7-Be)*Math.min(1,r*5);let x=(g?1:0)-(_?1:0);Ve+=x*1.4*r,x===0&&(Ve+=(0-Ve)*Math.min(1,r*1.6)),Ve=Ot.clamp(Ve,-.7,.7);let S=Math.cos(Ve);Je.set(S*Math.sin(Ie),Math.sin(Ve),S*Math.cos(Ie)),v&&Re.addScaledVector(Je,m*r),y&&Re.addScaledVector(Je,-m*.5*r);let C=Re.length();C>.01&&(Ze.copy(Je).multiplyScalar(C),Re.lerp(Ze,Math.min(1,r*2.5))),Re.multiplyScalar(Math.exp(-.5*r)),Re.length()>h&&Re.setLength(h),A.position.addScaledVector(Re,r),A.position.y=Math.max(-52,Math.min(52,A.position.y));let k=A.position.length();k>105&&(A.position.multiplyScalar(105/k),Re.multiplyScalar(.4)),A.rotation.y=Ie,j.rotation.x=-Ve,ee.rotation.z=Be;let M=v||y,te=1+(M?.9:0)+(f&&M?1.1:0)+Math.sin(Ge*20)*.12;for(let e of F)e.scale.setScalar(te);Me.thrust(M?1:0),Ye.set(0,0,-1.3).applyQuaternion(ee.getWorldQuaternion(Xe)).add(A.position),R.unshift(Ye.clone()),R.length>22&&R.pop();for(let e=0;e<je.length;e++){let t=R[e];if(t){je[e].position.copy(t);let n=1-e/22;je[e].material.opacity=(M?.5:.1)*n,je[e].scale.setScalar(1.4*n)}}d.current?(Ke.lerp(new K(A.position.x-Je.x*11,A.position.y+5+Math.max(0,Re.y)*.2,A.position.z-Je.z*11),Math.min(1,r*3)),l.position.copy(Ke),qe.lerp(new K(A.position.x+Je.x*6,A.position.y+1,A.position.z+Je.z*6),Math.min(1,r*4)),l.lookAt(qe)):(l.position.set(Math.cos(Ge*.14)*58,24+Math.sin(Ge*.3)*5,Math.sin(Ge*.14)*58),l.lookAt(0,17,0));let ne=7.5,N=-1;for(let e=0;e<D.length;e++){let t=D[e];t.grp.getWorldPosition(Ye);let n=A.position.distanceTo(Ye),r=n<10;t.mesh.material.emissiveIntensity=r?.18:0,t.atmo.material.opacity=r?.2:.08,t.label.visible=t.data.kind===`project`||n<38,n<ne&&(ne=n,N=e)}d.current&&N!==He&&(He=N,t.current=N,i(N)),o?s.render(c,l):p.render()}catch(e){Qe||(Qe=!0,console.error(`[Chiangverse loop error]`,e),y(String(e&&e.stack||e)))}}Ue=requestAnimationFrame($e);let V=()=>{r=n.clientWidth,a=n.clientHeight,s.setSize(r,a),p.setSize(r,a),l.aspect=r/a,l.updateProjectionMatrix()};return window.addEventListener(`resize`,V),()=>{cancelAnimationFrame(Ue),window.removeEventListener(`keydown`,Pe),window.removeEventListener(`keyup`,Fe),window.removeEventListener(`resize`,V),Me.close(),window.__verse&&delete window.__verse,p.dispose(),s.dispose(),s.domElement.parentNode&&s.domElement.parentNode.removeChild(s.domElement)}},[]);let C=t=>({onPointerDown:n=>{n.preventDefault(),e.current?._setKey?.(t,!0),e.current?._begin?.()},onPointerUp:n=>{n.preventDefault(),e.current?._setKey?.(t,!1)},onPointerLeave:()=>e.current?._setKey?.(t,!1),onPointerCancel:()=>e.current?._setKey?.(t,!1)}),w=()=>_(t=>{let n=!t;return e.current?._audio?.setMuted(n),n}),T=n>=0?Jl[n]:null,E=a>=0?Jl[a]:null,D=e=>e.kind===`project`?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`cv-tags`,children:e.tags.map(e=>(0,$.jsx)(`span`,{className:`cv-tag`,children:e},e))}),(0,$.jsx)(`div`,{className:`cv-projects`,children:e.projects.map(e=>(0,$.jsxs)(`div`,{className:`cv-proj glass`,children:[(0,$.jsx)(`div`,{className:`cv-proj-name`,children:e.name}),(0,$.jsx)(`p`,{className:`cv-proj-desc`,children:e.desc}),(0,$.jsx)(`div`,{className:`cv-proj-tech`,children:e.tech.map(e=>(0,$.jsx)(`span`,{children:e},e))}),(0,$.jsxs)(`div`,{className:`cv-proj-meta`,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`b`,{children:`角色`}),` `,e.role]}),(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`b`,{children:`成果`}),` `,e.impact]})]}),e.links?.demo&&(0,$.jsx)(`a`,{className:`cv-proj-link`,href:e.links.demo,children:`開啟 Demo ↗`})]},e.name))})]}):e.kind===`contact`?(0,$.jsxs)(`a`,{className:`cv-contact-go`,href:e.link,target:e.link.startsWith(`http`)?`_blank`:void 0,rel:`noreferrer`,children:[`前往 `,e.name,` →`]}):(0,$.jsxs)(`div`,{className:`cv-proj glass`,children:[(0,$.jsxs)(`div`,{className:`cv-proj-meta cv-record`,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`b`,{children:e.kind===`edu`?`學位`:`職位`}),` `,e.sub]}),(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`b`,{children:`期間`}),` `,e.period]}),e.extra&&(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`b`,{children:`成績`}),` `,e.extra]})]}),e.bullets?.length>0&&(0,$.jsx)(`ul`,{className:`cv-bullets`,children:e.bullets.map((e,t)=>(0,$.jsx)(`li`,{children:e},t))})]});return(0,$.jsxs)(`div`,{className:`cv-root`,children:[(0,$.jsx)(`div`,{className:`cv-canvas`,ref:e}),v&&(0,$.jsxs)(`pre`,{className:`cv-err`,children:[`⚠ 3D 迴圈錯誤（請把這段截圖給我）:`,`
`,v]}),!l&&(0,$.jsx)(`div`,{className:`cv-hero`,children:(0,$.jsxs)(`div`,{className:`cv-hero-inner`,children:[(0,$.jsx)(`div`,{className:`cv-hero-eyebrow`,children:`YU-CHIN CHIANG · 江昱瑾`}),(0,$.jsx)(`h1`,{className:`cv-hero-title cv-grad`,children:`The Chiangverse`}),(0,$.jsx)(`div`,{className:`cv-hero-kicker`,children:`DATA\xA0ANALYTICS · AI · QUANT · PRODUCT`}),(0,$.jsxs)(`p`,{className:`cv-hero-sub`,children:[`作品、學歷、經歷與證照，各自是一座小小的星系。`,(0,$.jsx)(`br`,{}),`駕駛飛船穿過去，靠近任何一顆星球，就能讀到它的故事。`]}),(0,$.jsx)(`button`,{className:`cv-enter`,onClick:S,children:`進入星圖 →`}),(0,$.jsx)(`div`,{className:`cv-hero-hint`,children:`↑↓←→ / WASD 飛行 · Shift 加速 · 按住 Space + ↑/↓ 爬升俯衝 · 靠近星球按 Enter`})]})}),l&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`cv-hud-top`,children:[(0,$.jsx)(`a`,{className:`cv-chip`,href:`/cv`,children:`履歷 · full CV →`}),(0,$.jsx)(`div`,{className:`cv-brand`,children:`The Chiangverse`}),(0,$.jsxs)(`div`,{className:`cv-hud-right`,children:[(0,$.jsx)(`button`,{className:`cv-chip`,onClick:()=>p(!0),children:`旅程`}),(0,$.jsx)(`button`,{className:`cv-chip`,onClick:()=>h(!0),children:`技能`}),(0,$.jsx)(`button`,{className:`cv-chip`,onClick:w,"aria-label":`mute`,children:g?`🔇`:`🔊`}),(0,$.jsxs)(`span`,{className:`cv-chip cv-count`,children:[`探索 `,s.size,` / `,Jl.length]})]})]}),T&&a<0&&(0,$.jsxs)(`button`,{className:`cv-prompt`,onClick:b,style:{borderColor:Hl(T.color)},children:[(0,$.jsx)(`span`,{className:`cv-prompt-name`,style:{color:Hl(T.color)},children:T.name}),(0,$.jsxs)(`span`,{className:`cv-prompt-tag`,children:[T.systemName,T.tagline?` · `+T.tagline:T.sub?` · `+T.sub:``]}),(0,$.jsx)(`span`,{className:`cv-prompt-cta`,children:`按 Enter / 點此進入 →`})]}),(0,$.jsxs)(`div`,{className:`cv-altpad`,children:[(0,$.jsx)(`button`,{className:`cv-pad`,...C(`av`),"aria-label":`ascend`,children:`⤒`}),(0,$.jsx)(`button`,{className:`cv-pad`,...C(`ad`),"aria-label":`descend`,children:`⤓`})]}),(0,$.jsxs)(`div`,{className:`cv-dpad`,children:[(0,$.jsx)(`button`,{className:`cv-pad cv-pad-up`,...C(`f`),"aria-label":`thrust`,children:`▲`}),(0,$.jsx)(`button`,{className:`cv-pad cv-pad-left`,...C(`l`),"aria-label":`left`,children:`◀`}),(0,$.jsx)(`button`,{className:`cv-pad cv-pad-down`,...C(`b`),"aria-label":`reverse`,children:`▼`}),(0,$.jsx)(`button`,{className:`cv-pad cv-pad-right`,...C(`r`),"aria-label":`right`,children:`▶`})]})]}),E&&(0,$.jsx)(`div`,{className:`cv-panel-wrap`,onClick:()=>o(-1),children:(0,$.jsxs)(`div`,{className:`cv-panel glass`,style:{"--accent":Hl(E.color)},onClick:e=>e.stopPropagation(),children:[(0,$.jsx)(`button`,{className:`cv-panel-close`,onClick:()=>o(-1),"aria-label":`close`,children:`✕`}),(0,$.jsx)(`div`,{className:`cv-panel-eyebrow`,style:{color:Hl(E.color)},children:E.systemName}),(0,$.jsx)(`h2`,{className:`cv-panel-title`,children:E.kind===`project`?E.tagline:E.name}),D(E)]})}),f&&(0,$.jsx)(`div`,{className:`cv-panel-wrap cv-center`,onClick:()=>p(!1),children:(0,$.jsxs)(`div`,{className:`cv-modal glass`,onClick:e=>e.stopPropagation(),children:[(0,$.jsx)(`button`,{className:`cv-panel-close`,onClick:()=>p(!1),"aria-label":`close`,children:`✕`}),(0,$.jsx)(`div`,{className:`cv-panel-eyebrow cv-grad-text`,children:`My Project Journey`}),(0,$.jsx)(`div`,{className:`cv-timeline`,children:[[`2022`,`媒體與影音製作`,16740039],[`2023`,`React Native 開發`,4647072],[`2024`,`深度學習與 AI`,8086015],[`2025`,`Data Analytics · Warwick 碩士`,54527],[`2026`,`Quant Research`,16765286],[`Future`,`AI × Quant × Product`,54527]].map(([e,t,n])=>(0,$.jsxs)(`div`,{className:`cv-tl-item`,children:[(0,$.jsx)(`span`,{className:`cv-tl-dot`,style:{background:Hl(n)}}),(0,$.jsx)(`span`,{className:`cv-tl-line`}),(0,$.jsxs)(`div`,{className:`cv-tl-body`,children:[(0,$.jsx)(`span`,{className:`cv-tl-year`,style:{color:Hl(n)},children:e}),(0,$.jsx)(`span`,{className:`cv-tl-label`,children:t})]})]},e))})]})}),m&&(0,$.jsx)(`div`,{className:`cv-panel-wrap cv-center`,onClick:()=>h(!1),children:(0,$.jsxs)(`div`,{className:`cv-modal glass`,onClick:e=>e.stopPropagation(),children:[(0,$.jsx)(`button`,{className:`cv-panel-close`,onClick:()=>h(!1),"aria-label":`close`,children:`✕`}),(0,$.jsx)(`div`,{className:`cv-panel-eyebrow cv-grad-text`,children:`Skill Constellations`}),(0,$.jsx)(`div`,{className:`cv-skills`,children:[[`Data & AI`,8086015,[`Python`,`Pandas`,`NumPy`,`PyTorch`,`Machine Learning`,`Statistics`]],[`Software`,54527,[`React`,`Next.js`,`Vue`,`React Native`,`Firebase`]],[`Quant`,16765286,[`Probability`,`Backtesting`,`Trading Strategy`,`Risk Management`]],[`Creative`,16740039,[`UI/UX`,`Storytelling`,`Video Production`,`Research`]]].map(([e,t,n])=>(0,$.jsxs)(`div`,{className:`cv-skill-group`,children:[(0,$.jsx)(`div`,{className:`cv-skill-head`,style:{color:Hl(t)},children:e}),(0,$.jsx)(`div`,{className:`cv-skill-items`,children:n.map(e=>(0,$.jsxs)(`span`,{className:`cv-skill`,children:[(0,$.jsx)(`span`,{className:`cv-skill-star`,style:{background:Hl(t)}}),e]},e))})]},e))})]})})]})}export{Xl as default};